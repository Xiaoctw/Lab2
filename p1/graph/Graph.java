...
/**
 * A mutable weighted directed graph with labeled vertices.(顶点)
 ...
 * You MUST NOT change the specifications（规格） or add additional methods.不能再接口中添加东西
 *
...
public interface Graph<L> {
     ...
     *
     * @param <L> type of vertex labels in the graph, must be immutable（不可变的）
     * @return a new empty weighted directed graph
     */
    public static <L> Graph<L> empty() {
        ConcreteEdgesGraph<L> graph=new ConcreteEdgesGraph<>();
       // return (graph < L) >;
    //   throw new RuntimeException("not implemented");
       // return <L>graph<L>;
        return (Graph<L>) graph;
    }
    ...
    /**
     * Add, change, or remove a weighted directed edge in this graph.（修改一条带有权值的边）
     ...
     * otherwise modified).如果权值为0，删除这条边
     *
